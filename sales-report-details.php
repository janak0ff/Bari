                                        ...
                                        <div class="table-wrap">
                                            <table id="datable_1" class="table table-hover w-100 display pb-30">
                                                ...
                                                <tbody>
                                                    ...
                                                    $query = mysqli_query($con, "select month(orders.InvoiceGenDate) as mnth,year(orders.InvoiceGenDate) as yearr,sum(orders.Quantity*products.ProductPrice) as tt  from orders join products on products.id=orders.ProductId  where date(orders.InvoiceGenDate) between '$fdate' and '$tdate' group by mnth,yearr");
                                                    $cnt = 1;
